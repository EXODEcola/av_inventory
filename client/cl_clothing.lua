...
RegisterNUICallback('AquiverInventory:ToggleClothing', function(args)
    ToggleClothing(args[1], args[2])
end)
RegisterNUICallback('AquiverInventory:ToggleProps', function(args)
    ToggleProps(args[1], args[2])
end)
...
local Drawables = {
	...
	["Shoes"] = {
		Drawable = 6,
		Table = {Standalone = true, Male = 88, Female = 35},
...
local Extras = {
	...
	["Pants"] = {
		Drawable = 4,
		Table = {Standalone = true, Male = 128, Female = 14},
